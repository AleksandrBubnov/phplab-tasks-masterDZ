...
{
    if ($year < 1900) throw new InvalidArgumentException('InvalidArgumentException');
...
{
    if (strlen($input) != 6) throw new InvalidArgumentException('InvalidArgumentException');
    if ($input[0] + $input[1] + $input[2] != $input[3] + $input[4] + $input[5]) return false;
